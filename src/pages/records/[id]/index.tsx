...
const ViewRecord = ({ dbRecord }: { dbRecord: DbRecord }) => {
  ...
  return (
    <div className="md:h-[calc(100vh-154px)]">
      <div className="container mx-auto flex flex-col min-w-0 break-words mt-10 bg-white border border-solid rounded border-[rgba(0,0,0,0.125)]">
